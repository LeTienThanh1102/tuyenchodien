  ...
  return (
    <div className="ranking">
        ...
        <div className="baocao1_container">
          {active===false ?<table className="table table-hover table-bordered">
          <thead>
            <tr>
          ...
          <tbody>
            <tr >
              <td>2992</td>
              <td>34%</td>
              <td><button className='btn-active' href='' onClick={()=>setActive(true)}>Chi tiết</button></td>
            </tr>
          </tbody>
        </table> :
        <div><table className="table table-hover table-bordered">
        <thead>
          <tr>
            <th scope="col">STT</th>
